---
layout: post
title: Euler's Number and its Relationship to Random Forests
...
Hence, random forests leave out $$\frac{1}{\mbox{e}}$$ of the cases in the training sample, which are then used later for a so called out-of-bag (OOB) error estimate.
